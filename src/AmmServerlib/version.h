...
#define VERSION_H
	...
	static const long REVISION  = 1217;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 239;
	#define RC_FILEVERSION 0,29,244,1217
	#define RC_FILEVERSION_STRING "0, 29, 244, 1217\0"
	static const char FULLVERSION_STRING [] = "0.29.244.1217";
