...
#define VERSION_H
	...
	static const long REVISION  = 4092;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 973;
	#define RC_FILEVERSION 0,34,812,4092
	#define RC_FILEVERSION_STRING "0, 34, 812, 4092\0"
	static const char FULLVERSION_STRING [] = "0.34.812.4092";
