...
#define VERSION_H
	...
	static const long REVISION  = 2446;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 593;
	#define RC_FILEVERSION 0,31,482,2446
	#define RC_FILEVERSION_STRING "0, 31, 482, 2446\0"
	static const char FULLVERSION_STRING [] = "0.31.482.2446";
