...
#define VERSION_H
	...
	static const long REVISION  = 438;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 95;
	#define RC_FILEVERSION 0,27,108,438
	#define RC_FILEVERSION_STRING "0, 27, 108, 438\0"
	static const char FULLVERSION_STRING [] = "0.27.108.438";
