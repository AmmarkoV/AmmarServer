...
#define VERSION_H
	...
	static const long REVISION  = 2982;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 736;
	#define RC_FILEVERSION 0,32,586,2982
	#define RC_FILEVERSION_STRING "0, 32, 586, 2982\0"
	static const char FULLVERSION_STRING [] = "0.32.586.2982";
