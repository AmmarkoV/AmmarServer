...
#define VERSION_H
	...
	static const long BUILD  = 208;
	static const long REVISION  = 1021;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 200;
	#define RC_FILEVERSION 0,28,208,1021
	#define RC_FILEVERSION_STRING "0, 28, 208, 1021\0"
	static const char FULLVERSION_STRING [] = "0.28.208.1021";
