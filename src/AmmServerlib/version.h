...
#define VERSION_H
	...
	static const long REVISION  = 3409;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 834;
	#define RC_FILEVERSION 0,33,677,3409
	#define RC_FILEVERSION_STRING "0, 33, 677, 3409\0"
	static const char FULLVERSION_STRING [] = "0.33.677.3409";
