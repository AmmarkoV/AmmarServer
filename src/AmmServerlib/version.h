...
#define VERSION_H
	...
	static const long REVISION  = 2912;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 701;
	#define RC_FILEVERSION 0,32,571,2912
	#define RC_FILEVERSION_STRING "0, 32, 571, 2912\0"
	static const char FULLVERSION_STRING [] = "0.32.571.2912";
