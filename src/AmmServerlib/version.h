...
#define VERSION_H
	...
	static const long REVISION  = 583;
	
	//Miscellaneous Version Types
	static const long BUILDS_COUNT  = 113;
	#define RC_FILEVERSION 0,27,132,583
	#define RC_FILEVERSION_STRING "0, 27, 132, 583\0"
	static const char FULLVERSION_STRING [] = "0.27.132.583";
