...
int AmmServer_ExecuteCommandLineAndRetreiveAllResults(const char *  command , char * what2GetBack , unsigned int what2GetBackMaxSize, unsigned long * what2GetBackSize)
{
  what2GetBack[0]=0;
