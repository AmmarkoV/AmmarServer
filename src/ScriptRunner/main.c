...
void execute(char * command,char * param)
{
  ...
  { ///bin/bash -c \"
    ...
    if (strcmp(param,"yes")==0) { strcpy(commandToRun,"rostopic pub /ActionSequence HobbitMsgs/Command \"command: 'G_YES'\" -1  "); } else
    if (strcmp(param,"no")==0) { strcpy(commandToRun,"rostopic pub /ActionSequence HobbitMsgs/Command \"command: 'G_NO'\" -1  "); } else
    if (strcmp(param,"stop")==0) { strcpy(commandToRun,"rostopic pub /ActionSequence HobbitMsgs/Command \"command: 'C_STOP'\" -1  "); } else
    if (strcmp(param,"call")==0) { strcpy(commandToRun,"rostopic pub /ActionSequence HobbitMsgs/Command \"command: 'E_CALLHOBBIT'\" -1  "); } else
    if (strcmp(param,"settings")==0) { strcpy(commandToRun,"rostopic pub /ActionSequence HobbitMsgs/Command \"command: 'F_SETTINGS'\" -1  "); } else
    ...
    if (strcmp(param,"closemic")==0) { strcpy(commandToRun,"rostopic pub /ActionSequence HobbitMsgs/Command \"command: 'F_ASR_OFF'\" -1  "); } else
    if (strcmp(param,"openmic")==0) { strcpy(commandToRun,"rostopic pub /ActionSequence HobbitMsgs/Command \"command: 'F_ASR_ON'\" -1  "); } else
